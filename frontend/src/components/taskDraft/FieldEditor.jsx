...
const FieldEditor = ({ field, screenId }) => {
  ...
  const [tempSampleValue, setTempSampleValue] = useState(
  ...
  const handleLabelChange = (value) => {
    dispatch(
      updateField({ screenId, fieldId: field.id, changes: { label: value } })
    );
  };
  ...
  const handleConfigChange = (key, value) => {
    dispatch(
      updateField({
        screenId,
        fieldId: field.id,
        changes: { config: { ...field.config, [key]: value } },
      })
    );
  };
        ...
        <>
          <div style={{ marginBottom: "14px" }}>
            ...
            <Select
              value={
                ...
                (field.type === "media-image" ? "image" : "file")
              }
          ...
          <div style={{ marginBottom: "14px" }}>
            ...
            <Input
              ...
              onChange={(e) =>
                handleConfigChange("maxSize", parseInt(e.target.value) || 5)
              }
              placeholder="5"
              min="1"
              style={{
          ...
          <div style={{ marginBottom: "14px" }}>
            ...
            {uploading ? (
              ...
              >
                <div>
                  <div
                    style={{ fontSize: 13, fontWeight: 500, color: "#0050b3" }}
                  >
                    {field.config.uploadedFile.name}
                  </div>
