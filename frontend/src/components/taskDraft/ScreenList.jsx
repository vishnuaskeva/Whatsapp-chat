...
import { addScreen, setActiveScreen, deleteScreen } from '../../features/taskDraft/taskDraftSlice';
    ...
    <Flex vertical gap={8}>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
        {task.screens.map((screen) => (
          <div key={screen.id} style={{ display: 'flex', gap: '8px', alignItems: 'center' }}>
            <Button
              style={{ 
                flex: 1, 
                textAlign: 'left',
                ...(activeScreenId === screen.id && { backgroundColor: '#25D366', borderColor: '#25D366', color: '#fff' })
              }}
