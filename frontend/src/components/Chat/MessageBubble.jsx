  ...
  return (
    <div style={{
      ...
      {!isSentByCurrentUser && false && (
        <Avatar 
          size={28} 
          style={{ backgroundColor: '#128C7E', marginRight: '8px', flexShrink: 0 }}
        >
            ...
            <div style={{
              ...
              {isSentByCurrentUser && (
                <div style={{ 
                  ...
                  <CheckOutlined style={{ fontSize: '11px', color: '#53bdeb', position: 'absolute', left: '0px' }} />
                  <CheckOutlined style={{ fontSize: '11px', color: '#53bdeb', position: 'absolute', left: '5px' }} />
                </div>
              )}
            </div>
          </div>
