import { Card, Typography, Divider, Tag, Input, Select, Button, Image } from 'antd';
      ...
      case 'media-file':
        ...
        if (uploadedFile) {
          ...
          return (
            <div style={{ marginBottom: 12 }}>
              {isImage ? (
                <div style={{ maxHeight: '200px', borderRadius: '4px', overflow: 'hidden', border: '1px solid #d9d9d9' }}>
    ...
    >
      ...
      {task.screens.map((screen, screenIdx) => (
        <div key={screen.id}>
          ...
          {/* Fields */}
          <div style={{ marginBottom: screenIdx === task.screens.length - 1 ? 0 : 16 }}>
